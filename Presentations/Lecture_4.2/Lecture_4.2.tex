	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\centering{\includegraphics[keepaspectratio, width  = \textwidth]{img/4CL1_knockoutTrees}}
						\centering{\includegraphics[keepaspectratio, width  = \textwidth]{img/4CL1_knockout_bendy}}
		\end{column}
		\begin{column}{0.5\textwidth}
	\begin{itemize}
...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			\centering{\includegraphics[keepaspectratio, width  = 0.7\textwidth]{img/4CL1_knockoutTrees}}
			\centering{\includegraphics[keepaspectratio, width  = \textwidth]{img/4CL1_knockout_result}}
		\end{column}
		\begin{column}{0.5\textwidth}
			\begin{itemize}
...
\begin{frame}
	\frametitle{Comparing Different Approaches}
			\centering{\includegraphics[keepaspectratio, width  = \textwidth]{img/overview}}
...
\begin{frame}
	\frametitle{The Public's Views}
				\centering{\includegraphics[keepaspectratio, width  = \textwidth]{img/publicViews}}
